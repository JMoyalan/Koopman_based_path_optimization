...
A_fin = readmatrix('Terrain Map.xlsx','Sheet','hill_and_pit');
...
Dom_columns = [-3.5 3.5]; % Domain x1
Dom_rows = [-3.5 3.5]; % Domain x2
dis = 10.5;    %dis = 12 for vel bounds = 1; dis = 10 for vel bounds = 0.3;
...
for j = 1:Ninit
   ...
   for i = 0:Nsim-1
        ...
        u_second_value(1,i+1) = (x_true_second(1,i+2)-x_true_second(1,i+1))/0.01;
        u_second_value(2,i+1) = (x_true_second(2,i+2)-x_true_second(2,i+1))/0.01;
